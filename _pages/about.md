...
For my master's thesis, I investigated crop type mapping in the smallholder cropping systems of the cotton belt in Mali using multi-temporal Sentinel-1 SAR and Sentinel-2 optical imagery. The research examined individual and combined satellite observations across different stages of the growing season and explored the importance of spectral, temporal, and textural information for crop discrimination.
...
- Multi-sensor and Multi-temporal Satellite Data
...
My master's research investigated the potential of Sentinel-1 SAR and Sentinel-2 optical satellite observations for crop type mapping in heterogeneous smallholder agricultural landscapes in Dioila, Mali.

The study compared Sentinel-1, Sentinel-2, and fused multi-sensor datasets across different stages of the cropping season to understand how classification performance changes with temporal information and sensor availability.

[Learn more about my research →](/academicpages-test/research/)
